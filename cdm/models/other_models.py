...
_house_vote_metrics_lock = Lock()
_house_vote_metrics = {"candidate_style_detections": 0}


def get_house_vote_metrics() -> dict[str, int]:
    """Return counters collected while normalizing House vote payloads."""
    with _house_vote_metrics_lock:
        return dict(_house_vote_metrics)


def reset_house_vote_metrics() -> None:
    """Reset House vote normalization counters, primarily for test isolation."""
    with _house_vote_metrics_lock:
        for key in _house_vote_metrics:
            _house_vote_metrics[key] = 0


def _record_candidate_style_detection() -> None:
    with _house_vote_metrics_lock:
        _house_vote_metrics["candidate_style_detections"] += 1
...
class Subject(BaseModel):
    ...
    update_date: Annotated[
        datetime | None, Field(description="When the subject was last updated.")
    ] = None
...
class Topic(BaseModel):
    ...
    update_date: Annotated[
        datetime | None, Field(description="When the topic was last updated.")
    ] = None
...
class HouseCommunication(EntityBase):
    ...
    congress: Annotated[
        int | None, Field(description="Which Congress the communication belongs to.")
    ] = None
    number: Annotated[
        int | None, Field(description="What the communication number is.")
    ] = None
    chamber: Annotated[
        str | None, Field(description="Which chamber sent the communication.")
    ] = None

    type: Annotated[
        str | None, Field(description="What type of communication this is.")
    ] = None
    ...
    date: Annotated[
        datetime | None, Field(description="When the communication was submitted.")
    ] = None
    url: Annotated[
        HttpUrl | None,
    ...
    subject: Annotated[
        Subject | None, Field(description="What subject the communication concerns.")
    ] = None
    sender: Annotated[str | None, Field(description="Who sent the communication.")] = (
        None
    )
    recipient: Annotated[
        str | None, Field(description="Who received the communication.")
    ] = None
        ...
        if not values.get("url"):
            ...
            if congress is not None and number is not None and comm_type:
                try:
                    ...
                    logger.exception("Failed to construct house communication URL")
...
class HouseRequirement(EntityBase):
    ...
    description: Annotated[
        str | None, Field(description="What the requirement describes.")
    ] = None
    date: Annotated[
        datetime | None, Field(description="When the requirement was recorded.")
    ] = None
    url: Annotated[
        HttpUrl | None,
...
class NomineePosition(BaseModel):
    ...
    ordinal: Annotated[int | None, Field(default=None)] = None
    nominee_count: Annotated[int | None, Field(default=None, alias="nomineeCount")] = (
        None
    )
    organization: Annotated[str | None, Field(default=None)] = None
    position_title: Annotated[
        str | None, Field(default=None, alias="positionTitle")
    ] = None
    intro_text: Annotated[str | None, Field(default=None, alias="introText")] = None
...
class Nomination(EntityBase):
    ...
    authority_date: Annotated[
        datetime | None, Field(default=None, alias="authorityDate")
    ] = None
    received_date: Annotated[
        datetime | None, Field(default=None, alias="receivedDate")
    ] = None
    update_date: Annotated[datetime | None, Field(default=None, alias="updateDate")] = (
        None
    )
    ...
    nominees: Annotated[list["NomineePosition"] | None, Field(default=None)] = None
    actions: Annotated[CountUrl | None, Field(default=None)] = None
    hearings: Annotated[CountUrl | None, Field(default=None)] = None
    committees: Annotated[CountUrl | None, Field(default=None)] = None

    # convenience/derived fields (kept for backwards compatibility)
    nominee: Annotated[
        str | None, Field(default=None, description="Who the nominee is.")
    ] = None
    position: Annotated[
        str | None,
    ...
    def _populate_common_fields(cls, values: dict):
        ...
        if not values.get("position") and isinstance(nominees, list) and nominees:
            try:
                first = nominees[0]
                ...
                logger.debug("Could not derive nomination position")

        # derive `nominee` from first nominee organization/intro_text if missing
        if not values.get("nominee") and isinstance(nominees, list) and nominees:
            try:
                first = nominees[0]
                if isinstance(first, dict):
                ...
                logger.debug("Could not derive nomination organization")

        return values

    def build_id(self) -> str:
        """Build a stable nomination id, including a partition when present."""
        if self.id:
            return self.id
        identifier = f"nomination:{self.congress}:{self.number}"
        if self.part_number is not None:
            identifier += f":part{self.part_number}"
        return identifier
...
class CRSReport(EntityBase):
    ...
    summary: Annotated[
        str | None, Field(description="What summary text the report provides.")
    ] = None
    authors: Annotated[
        list[str] | None, Field(description="Who authored the CRS report.")
    ] = None
    topics: Annotated[
        list[Topic] | None, Field(description="Which topics the CRS report covers.")
    ] = None
...
class EntireIssueEntry(BaseModel):
    ...
    type: Annotated[
        str | None, Field(default=None, alias="type", description="Format type")
    ] = None
    url: Annotated[
        HttpUrl | None,
...
class DailySection(BaseModel):
    ...
    name: Annotated[
        str | None, Field(default=None, alias="name", description="Section name")
    ] = None
    text: Annotated[
        list[Format] | None,
        Field(
...
class MemberDepiction(BaseModel):
    ...
    attribution: Annotated[
        str | None, Field(description="Who to credit for the member image.")
    ] = None
    image_url: Annotated[
        HttpUrl | None,
        Field(
...
class MemberTermItem(BaseModel):
    ...
    chamber: Annotated[
        str | None, Field(description="Which chamber the term was served in.")
    ] = None
...
class NominationLatestAction(BaseModel):
    ...
    text: Annotated[
        str | None, Field(description="What the latest action text says.")
    ] = None
...
class NominationListItem(EntityBase, RecordTypeBase):
    ...
    citation: Annotated[
        str | None, Field(description="What the official nomination citation is.")
    ] = None
    description: Annotated[
        str | None, Field(description="What the nomination describes.")
    ] = None
    received_date: Annotated[
        datetime | None,
        Field(
    ...
    organization: Annotated[
        str | None, Field(description="Which organization the nomination is for.")
    ] = None
...
class CRSReportListItem(EntityBase, RecordTypeBase):
    ...
    status: Annotated[
        str | None, Field(description="What the CRS report status is.")
    ] = None
    ...
    version: Annotated[
        int | str | None, Field(description="Which version of the report this is.")
    ] = None
    ...
    title: Annotated[str | None, Field(description="What the report title is.")] = None
    url: Annotated[
        HttpUrl | None, Field(description="Where to retrieve the report in the API.")
    ] = None
...
class BillSummaryBill(BaseModel):
    ...
    title: Annotated[str | None, Field(description="What the bill title is.")] = None
...
class BillSummaryListItem(EntityBase, RecordTypeBase):
    ...
    text: Annotated[str | None, Field(description="What the summary text says.")] = None
    action_date: Annotated[
        datetime | None,
        Field(
            default=None,
...
class HouseRollCallVoteListItem(EntityBase, RecordTypeBase):
    ...
    identifier: Annotated[
        int | str | None, Field(description="What the roll call vote identifier is.")
    ] = None
    congress: Annotated[
        int | None, Field(description="Which Congress the vote belongs to.")
    ] = None
    session_number: Annotated[
        int | None,
        Field(
    ...
    result: Annotated[str | None, Field(description="What the vote result was.")] = None
    ...
    def _normalize_vote_fields(cls, values: dict):
        ...
        if isinstance(vpt, list):
            ...
            if is_candidate_style:
                ...
                _record_candidate_style_detection()
                logger.debug(
...
class DailyCongressionalRecordIssue(EntityBase, RecordTypeBase):
    ...
    congress: Annotated[
        int | None, Field(description="Which Congress the record issue belongs to.")
    ] = None
        ...
        try:
            ...
            if vol is not None and issue is not None:
                try:
                    ...
                    logger.exception(
                        "Failed to coerce volume/issue to int for id build"
                    )
                    return f"daily-congressional-record:{vol}:{issue}"
        except (AttributeError, TypeError, ValueError):
            logger.exception(
                "Unexpected error while building daily congressional record id"
            )
...
class BoundCongressionalRecordListItem(EntityBase, RecordTypeBase):
    ...
    date: Annotated[
        datetime | None, Field(description="When the bound record was published.")
    ] = None
    volume_number: Annotated[
        int | str | None,
        Field(
    ...
    def _normalize_bound_record_fields(cls, values: dict):
        ...
        if isinstance(normalized, dict):
            ddn = normalized
            start_page = ddn.get("startPage")
            if start_page and not ddn.get("start_page"):
                ddn["start_page"] = start_page
            end_page = ddn.get("endPage")
            if end_page and not ddn.get("end_page"):
                ddn["end_page"] = end_page
            if "startPage" in ddn:
    ...
    def _populate_url_from_date(cls, values: dict):
        ...
        try:
            ...
            elif hasattr(dt, "year") and dt:
                year = str(dt.year)
                month = str(dt.month)
                day = str(dt.day)
        except (AttributeError, TypeError, ValueError):
            logger.exception("Failed to parse date for URL synthesis")
            year = month = day = None
    ...
    def build_id(self) -> str:
        ...
        if year and month and day:
            try:
                ...
                logger.exception(
                    "Unexpected error while building bound congressional record id"
                )
...
class CommitteeListItem(EntityBase, RecordTypeBase):
    ...
    name: Annotated[str | None, Field(description="What the committee name is.")] = None
    chamber: Annotated[
...
class CommitteeReportListItem(EntityBase, RecordTypeBase):
    ...
    citation: Annotated[
        str | None, Field(description="What the committee report citation is.")
    ] = None
    ...
    congress: Annotated[
        int | None, Field(description="Which Congress the report belongs to.")
    ] = None
    chamber: Annotated[
        str | None, Field(description="Which chamber issued the report.")
    ] = None
    type: Annotated[
        str | None, Field(description="What type of committee report this is.")
    ] = None
    number: Annotated[int | None, Field(description="What the report number is.")] = (
        None
    )
    part: Annotated[
        int | None, Field(description="Which part of a multi-part report this is.")
    ] = None
...
class AmendmentListItem(EntityBase, RecordTypeBase):
    ...
    congress: Annotated[
        int | None, Field(description="Which Congress the amendment belongs to.")
    ] = None
    description: Annotated[
        str | None, Field(description="What the amendment description says.")
    ] = None
    latest_action: Annotated[
        AmendmentLatestAction | None,
        Field(
            default=None, alias="latestAction", description="What the latest action is."
        ),
    ]
    number: Annotated[
        str | None, Field(description="What the amendment number is.")
    ] = None
    purpose: Annotated[
        str | None, Field(description="What purpose the amendment states.")
    ] = None
    type: Annotated[
        str | None, Field(description="What type of amendment this is.")
    ] = None
    update_date: Annotated[
        datetime | None,
        Field(
...
class LawEntry(BaseModel):
    ...
    number: Annotated[str | None, Field(description="What the law number is.")] = None
    type: Annotated[
        str | None, Field(description="What type of law this is (public/private).")
    ] = None
...
class BillListItem(EntityBase, RecordTypeBase):
    ...
    congress: Annotated[
        int | None, Field(description="Which Congress the bill belongs to.")
    ] = None
    latest_action: Annotated[
        BillLatestAction | None,
        Field(
            default=None, alias="latestAction", description="What the latest action is."
        ),
    ]
    number: Annotated[str | None, Field(description="What the bill number is.")] = None
    origin_chamber: Annotated[
        str | None,
        Field(
            default=None,
    ...
    title: Annotated[str | None, Field(description="What the bill title is.")] = None
    type: Annotated[str | None, Field(description="What type of bill this is.")] = None
    update_date: Annotated[
        datetime | None,
        Field(
            default=None,
    ...
    url: Annotated[
        HttpUrl | None, Field(description="Where to retrieve the bill in the API.")
    ] = None
...
class LawListItem(EntityBase, RecordTypeBase):
    ...
    congress: Annotated[
        int | None, Field(description="Which Congress the law belongs to.")
    ] = None
    latest_action: Annotated[
        BillLatestAction | None,
        Field(
    ...
    url: Annotated[
        HttpUrl | None, Field(description="Where to retrieve the law in the API.")
    ] = None
...
class CommitteeMeetingListItem(EntityBase, RecordTypeBase):
    ...
    congress: Annotated[
        int | None, Field(description="Which Congress the meeting belongs to.")
    ] = None
    chamber: Annotated[
        str | None, Field(description="Which chamber the meeting belongs to.")
    ] = None
...
class HearingListItem(EntityBase, RecordTypeBase):
    ...
    chamber: Annotated[
        str | None, Field(description="Which chamber held the hearing.")
    ] = None
    congress: Annotated[
        int | None, Field(description="Which Congress the hearing belongs to.")
    ] = None
    number: Annotated[int | None, Field(description="What the hearing number is.")] = (
        None
    )
    part: Annotated[
        int | None, Field(description="Which part of a multipart hearing this is.")
    ] = None
    url: Annotated[
        HttpUrl | None,
...
class TreatyListItem(EntityBase, RecordTypeBase):
    ...
    number: Annotated[int | None, Field(description="What the treaty number is.")] = (
        None
    )
    parts: Annotated[
        dict[str, object] | None,
    ...
    suffix: Annotated[
        str | None, Field(description="What suffix the treaty carries.")
    ] = None
    topic: Annotated[
        str | None, Field(description="What topic the treaty concerns.")
    ] = None
...
class MemberListItem(EntityBase, RecordTypeBase):
    ...
    name: Annotated[
        str | None, Field(description="What the member's display name is.")
    ] = None
    depiction: Annotated[
        MemberDepiction | None,
