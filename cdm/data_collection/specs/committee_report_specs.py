from cdm.data_collection.endpoint_registry import get_spec, register_from_model
from cdm.models.bills import CommitteeReport
from cdm.models.other_models import CommitteeReportListItem
...
__all__ = ["COMMITTEE_REPORT_ITEM_SPEC", "COMMITTEE_REPORT_LIST_SPEC"]
