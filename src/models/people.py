...
class Session(BaseModel):
    ...
    start_date: Annotated[
        datetime,
        Field(alias="startDate", description="When the session started.")
    ]
...
class Congress(BaseModel):
    ...
    number: Annotated[int, Field(description="Which Congress number this record is for.")]
    url: Annotated[HttpUrl, Field(description="Where to retrieve the Congress record in the API.")]
    update_date: Annotated[
        datetime,
        Field(alias="updateDate", description="When the Congress record was last updated.")
    ]
    start_year: Annotated[
        int,
        Field(alias="startYear", description="What year this Congress started.")
    ]
    end_year: Annotated[
        int,
        Field(alias="endYear", description="What year this Congress ended.")
    ]
...
class CongressMetadata(BaseModel):
    ...
    number: Annotated[int, Field(description="Which Congress number this metadata refers to.")]

class Depiction(BaseModel): 
    """Member image metadata including attribution and image URL."""
    attribution: Annotated[str, Field(description="Who to credit for the member image.")]
    image_url: Annotated[
        Optional[HttpUrl],
        Field(alias="imageUrl", default=None, description="Where to fetch the member image.")
    ]
...
class Term(BaseModel):
    ...
    chamber: Annotated[Chamber, Field(description="Which chamber the term was served in.")]
    end_year: Annotated[
        int,
    ...
    start_year: Annotated[
        int,
        Field(alias="startYear", default=None, description="What year the term started.")
    ]
...
class Member(BaseModel):
    ...
    bioguide_id: Annotated[
        str,
        Field(alias="bioguideId", description="What the Bioguide identifier is.")
    ]
    first_name: Annotated[
        str,
        Field(alias="firstName", description="What the member's first name is.")
    ]
    full_name: Annotated[
        str,
        Field(
    ...
    last_name: Annotated[
        str,
        Field(alias="lastName", description="What the member's last name is.")
    ]
    party: Annotated[
        str,
        Field(
    ...
    state: Annotated[str, Field(description="Which state or territory the member represents.")]
    url: Annotated[HttpUrl, Field(description="Where to retrieve the member record in the API.")]
    middle_name: Annotated[
        str,
        Field(alias="middleName", description="What the member's middle name or initial is."),
    ] = ""
    district: Annotated[
        Optional[int],
    ...
    is_by_request: Annotated[
        str,
        Field(alias="isByRequest", description="Whether the measure was introduced by request.")
    ] = ""
    depiction: Annotated[
        Depiction,
        Field(alias="depiction", description="What image information is available for the member.")
    ] = Depiction.empty()
...
class Sponsor(Member):
    ...
    sponsorship_date: Annotated[
        datetime,
        Field(alias="sponsorshipDate", description="When sponsorship began.")
    ]
    is_original_cosponsor: Annotated[
        bool,
        Field(
