...
from src.models.people import Member, Sponsor, Chamber
...
class Hearing(BaseModel):
    ...
    url: Annotated[HttpUrl, Field(description="Where to retrieve the hearing in the API.")]
    chamber: Annotated[Chamber, Field(description="Which chamber held the hearing.")]
    committee_name: Annotated[
        Optional[str],
        Field(description="Which committee held the hearing.")
    ] = None
    hearing_date: Annotated[
        Optional[datetime],
        Field(description="When the hearing took place.")
    ] = None
    type: Annotated[
        Optional[str],
        Field(description="What type of hearing this is.")
    ] = None
...
class Format(BaseModel):
    ...
    url: Annotated[HttpUrl, Field(description="Where to retrieve the formatted content.")]
...
class TextVersion(BaseModel):
    ...
    formats: Annotated[List[Format], Field(description="Which formats are available for this text.")]
...
class Note(BaseModel):
    ...
    texts: Annotated[
        List[str],
        Field(alias="text", description="Which note entries are present.")
    ] = []
...
class Summary(BaseModel):
    ...
    action_desc: Annotated[
        str,
        Field(alias="actionDesc", description="What the summary action describes.")
    ]
    ...
    version_code: Annotated[
        str,
        Field(alias="versionCode", description="Which summary version this is.")
    ]
...
class Activity(BaseModel):
    ...
    date: Annotated[datetime, Field(description="When the committee activity occurred.")]
...
class CountUrl(BaseModel):
    ...
    url: Annotated[HttpUrl, Field(description="Where to retrieve the related list in the API.")]
...
class Title(BaseModel):
    ...
    title_type: Annotated[
        str,
        Field(alias="titleType", description="What type of title this is.")
    ]
    title_type_code: Annotated[
        int,
        Field(alias="titleTypeCode", description="What the title type code is.")
    ]
    update_date: Annotated[
        datetime,
    ...
    bill_text_version_code: Annotated[
        str,
        Field(alias="billTextVersionCode", description="Which bill text version code is referenced.")
    ] = ""
    bill_text_version_name: Annotated[
        str,
        Field(alias="billTextVersionName", description="What the bill text version name is.")
    ] = ""
...
class LawMetadata(BaseModel):
    ...
    law_type: Annotated[
        LawType,
        Field(alias="type", description="What type of law this is.")
    ]
...
class Committee(BaseModel):
    ...
    chamber: Annotated[str, Field(description="Which chamber the committee belongs to.")]
    ...
    url: Annotated[HttpUrl, Field(description="Where to retrieve the committee in the API.")]
...
class RecordedVote(BaseModel):
    ...
    roll_number: Annotated[
        int,
        Field(alias="rollNumber", description="What the roll call number is.")
    ]
    url: Annotated[HttpUrl, Field(description="Where to retrieve the vote in the API.")]
    chamber: Annotated[
        Chamber,
        Field(alias="chamber", description="Which chamber held the vote.")
    ]
...
class Action(BaseModel):
    ...
    action_code: Annotated[
        str,
        Field(alias="actionCode", description="What the action code is.")
    ] = ""
    ...
    recorded_votes: Annotated[
        List[RecordedVote],
        Field(alias="recordedVotes", description="Which recorded votes are tied to the action.")
    ] = []

class AmendmentMetadata(BaseModel):
    """List-level metadata describing an amendment reference."""
    congress: Annotated[int, Field(description="Which Congress the amendment belongs to.")]
    ...
    url: Annotated[HttpUrl, Field(description="Where to retrieve the amendment in the API.")]
...
class Treaty(BaseModel):
    ...
    url: Annotated[HttpUrl, Field(description="Where to retrieve the treaty in the API.")]

class Subjects(BaseModel):
    """Subject bundle containing legislative subjects and policy area."""
    legislative_subjects: Annotated[
        List[LegislativeSubject],
        Field(alias="legislativeSubjects", description="Which legislative subjects apply.")
    ] = []
...
class BillMetadata(BaseModel):
    ...
    relationship_details: Annotated[
        ...
        Field(alias="relationshipDetails", description="What relationship details are recorded.")
    ] = []
...
class Amendment(BaseModel):
    ...
    # Normal fields
    congress: Annotated[int, Field(description="Which Congress the amendment belongs to.")]
    description: Annotated[str, Field(description="What the amendment description says.")]
    purpose: Annotated[str, Field(description="What purpose the amendment states.")]
    latest_action: Annotated[
        Optional[LatestAction],
        Field(alias="latestAction", description="What the latest action is.")
    ...
    sponsors: Annotated[
        List[Member],
        Field(description="Which members sponsored the amendment.")
    ] = []
    on_behalf_of_sponsor: Annotated[
        Optional[Member],
        Field(alias="onBehalfOfSponsor", description="Who introduced the amendment on behalf of the sponsor.")
    ] = None
    behalf_type: Annotated[
        Optional[BehalfType],
        Field(alias="behalfType", description="What type of on-behalf-of sponsorship applies.")
    ] = None
    ...
    chamber: Annotated[
        Optional[Chamber],
        Field(alias="chamber", description="Which chamber the amendment is associated with.")
    ] = None
    amended_treaty: Annotated[
        Optional[Treaty],
        Field(alias="amendedTreaty", description="Which treaty is amended, if applicable.")
    ] = None
            ...
            for format in text_version.formats:
                if "Formatted" in format.type:
                    try:
                        ...
                        raise RuntimeError(f"Network error retrieving full text for text version {self.type}: {e}") from e
                    except (AttributeError, TypeError) as e:
                        raise RuntimeError(f"Parsing error for full text in text version {self.type}: {e}") from e
                    return full_text
        return ""
    ...
    def get_amendment_details(self, client: CDGClient):
        ...
        self.actions = [Action(**x) for x in amendment_data["actions"] if isinstance(x, dict)]
        self.cosponsors = [Member(**x) for x in amendment_data["cosponsors"] if isinstance(x, dict)]
        self.text_versions = [TextVersion(**x) for x in amendment_data["textVersions"] if isinstance(x, dict)]
...
class Bill(BaseModel):
    ...
    origin_chamber_code: Annotated[
        ChamberCode,
        Field(alias="originChamberCode", description="What the origin chamber code is.")
    ]
    policy_area: Annotated[
        Optional[PolicyArea],
        Field(alias="policyArea", description="What policy area the bill is classified under.")
    ] = None
    sponsors: Annotated[
        List[Sponsor],
    ...
    update_date_including_text: Annotated[
        datetime,
        Field(alias="updateDateIncludingText", description="When the bill or its text was last updated.")
    ]
    notes: Annotated[
        Optional[Note],
    ...
    def add_bill_details(self, client: CDGClient):
        ...
        legislative_subjects = [LegislativeSubject(**x) for x in subjects_data.get("legislativeSubjects", [])]
        policy_area = PolicyArea(**subjects_data["policyArea"]) if "policyArea" in subjects_data else PolicyArea(name="")
        self.subjects = Subjects(legislative_subjects=legislative_subjects, policy_area=policy_area)
...
class Law(Bill):
    ...
    is_law: Annotated[bool, Field(description="Whether the bill is enacted into law.")] = True

# Committee Report model
class CommitteeReport(BaseModel):
    """Committee report metadata with citation and issuance details."""
    citation: Annotated[str, Field(description="What the committee report citation is.")]
    url: Annotated[HttpUrl, Field(description="Where to retrieve the committee report in the API.")]
    chamber: Annotated[Chamber, Field(description="Which chamber issued the report.")]
    committee_name: Annotated[
        Optional[str],
        Field(description="Which committee issued the report.")
    ] = None
    report_date: Annotated[
        Optional[datetime],
        Field(description="When the report was issued.")
    ] = None
    type: Annotated[
        Optional[str],
        Field(description="What type of report this is.")
    ] = None
...
class CommitteePrint(BaseModel):
    ...
    url: Annotated[HttpUrl, Field(description="Where to retrieve the committee print in the API.")]
    chamber: Annotated[Chamber, Field(description="Which chamber issued the print.")]
    committee_name: Annotated[
        Optional[str],
        Field(description="Which committee issued the print.")
    ] = None
    print_date: Annotated[
        Optional[datetime],
        Field(description="When the print was issued.")
    ] = None
    type: Annotated[
        Optional[str],
        Field(description="What type of committee print this is.")
    ] = None
...
class CommitteeMeeting(BaseModel):
    ...
    url: Annotated[HttpUrl, Field(description="Where to retrieve the meeting in the API.")]
    chamber: Annotated[Chamber, Field(description="Which chamber held the meeting.")]
    committee_name: Annotated[
        Optional[str],
        Field(description="Which committee held the meeting.")
    ] = None
    meeting_date: Annotated[
        Optional[datetime],
        Field(description="When the meeting occurred.")
    ] = None
    type: Annotated[
        Optional[str],
        Field(description="What type of meeting this is.")
    ] = None
