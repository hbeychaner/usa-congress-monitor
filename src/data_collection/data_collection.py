...
def get_bills_metadata(client: CDGClient, from_date: str, to_date: str, offset: int = 0) -> tuple[list[Any], int, int]:
    """
    ...
    if isinstance(response, dict):
        ...
        if isinstance(pagination, dict) and "next" in pagination:
            offset = client.extract_offset(pagination["next"])
...
def get_laws_metadata(client: CDGClient, congress: int, offset: int = 0) -> tuple[list[Any], int, int]:
    """
...
def get_amendments_metadata(client: CDGClient, from_date: str, to_date: str, offset: int = 0, limit: int = RESULT_LIMIT) -> tuple[list[Any], int, int]:
    """
...
def extract_offset(client: CDGClient, url: str) -> int:
...
def get_members_by_state_and_district(client: CDGClient, state_code: str, district: int):
    """Retrieve a list of members filtered by state and district."""
    return client.get(f"member/{state_code}/{district}")

def get_members_by_congress_state_and_district(client: CDGClient, congress: int, state_code: str, district: int):
...
def get_committees_by_congress_and_chamber(client: CDGClient, congress: int, chamber: str):
...
def get_committee_details(client: CDGClient, chamber: str, committee_code: str):
...
def get_committee_reports(client: CDGClient, chamber: str, committee_code: str):
...
def get_committee_house_communications(client: CDGClient, chamber: str, committee_code: str):
...
def get_committee_senate_communications(client: CDGClient, chamber: str, committee_code: str):
...
def get_committee_reports_by_congress_and_type(client: CDGClient, congress: int, report_type: str):
...
def get_committee_report_details(client: CDGClient, congress: int, report_type: str, report_number: int):
...
def get_committee_report_text(client: CDGClient, congress: int, report_type: str, report_number: int):
...
def get_committee_prints_by_congress_and_chamber(client: CDGClient, congress: int, chamber: str):
...
def get_committee_print_details(client: CDGClient, congress: int, chamber: str, jacket_number: str):
...
def get_committee_print_text(client: CDGClient, congress: int, chamber: str, jacket_number: str):
...
def get_committee_meetings_by_congress_and_chamber(client: CDGClient, congress: int, chamber: str):
...
def get_committee_meeting_details(client: CDGClient, congress: int, chamber: str, event_id: str):
...
def get_hearings_by_congress_and_chamber(client: CDGClient, congress: int, chamber: str):
    """Retrieve a list of hearings filtered by the specified congress and chamber."""
    return client.get(f"hearing/{congress}/{chamber}")

def get_hearing_details(client: CDGClient, congress: int, chamber: str, jacket_number: str):
...
def get_daily_congressional_records_by_volume_and_issue(client: CDGClient, volume_number: int, issue_number: int):
...
def get_daily_congressional_record_articles(client: CDGClient, volume_number: int, issue_number: int):
    ...
    return client.get(f"daily-congressional-record/{volume_number}/{issue_number}/articles")
...
def get_bound_congressional_records_by_year_and_month(client: CDGClient, year: int, month: int):
...
def get_bound_congressional_records_by_year_month_and_day(client: CDGClient, year: int, month: int, day: int):
...
def get_house_communications_by_congress_and_type(client: CDGClient, congress: int, communication_type: str):
...
def get_house_communication_details(client: CDGClient, congress: int, communication_type: str, communication_number: int):
    """Retrieve detailed information for a specified House communication."""
    return client.get(f"house-communication/{congress}/{communication_type}/{communication_number}")
...
def get_matching_communications_for_house_requirement(client: CDGClient, requirement_number: int):
...
def get_senate_communications_by_congress_and_type(client: CDGClient, congress: int, communication_type: str):
...
def get_senate_communication_details(client: CDGClient, congress: int, communication_type: str, communication_number: int):
    """Retrieve detailed information for a specified Senate communication."""
    return client.get(f"senate-communication/{congress}/{communication_type}/{communication_number}")
...
def get_nominees_for_nomination(client: CDGClient, congress: int, nomination_number: int, ordinal: int):
...
def get_partitioned_treaty_details(client: CDGClient, congress: int, treaty_number: int, treaty_suffix: str):
...
def get_partitioned_treaty_actions(client: CDGClient, congress: int, treaty_number: int, treaty_suffix: str):
